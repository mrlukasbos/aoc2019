...
get_range full_list corner 
    | (last full_list) > corner = full_list ++ reverse (range (corner, (last full_list)))
    | otherwise = full_list ++ range ((last full_list), corner)
